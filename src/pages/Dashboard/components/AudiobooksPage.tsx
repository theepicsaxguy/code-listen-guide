    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {filteredAudiobooks.map((book: Job) => (
          <Card
            key={book.id}
            className="group h-full cursor-pointer transition-colors hover:bg-surface-secondary/50"
            ...
            <CardHeader className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  <CardTitle className="truncate text-base font-semibold text-foreground">{book.repo_name}</CardTitle>
              ...
              {book.status !== 'completed' && book.status !== 'failed' && (
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    <span className="font-semibold text-foreground">{book.progress_percentage}%</span>
                  </div>
