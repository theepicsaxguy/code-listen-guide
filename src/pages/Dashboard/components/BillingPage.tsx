...
export const BillingPage: React.FC = () => {
 ...
 {/* Success Message */}
 {showUpgradeSuccess && (
 <div className="bg-success/20 border border-success/30 text-success px-6 py-4 rounded-lg flex items-center justify-between animate-slide-down">
 ...
 className="px-6 py-3 bg-primary hover:opacity-90 text-primary-foreground rounded-lg font-bold transition-all shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 flex items-center gap-2"
 >
 ...
 <div
 className="bg-primary h-full rounded-full transition-all duration-500 shadow-sm shadow-primary/30"
 ...
 <div className="p-5 bg-surface rounded-lg transition-colors">
 ...
 <button className="p-2.5 rounded-lg text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all">
 ...
 <div className="p-12 text-center bg-secondary/30 rounded-lg">
 ...
 <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-surface rounded-lg shadow-2xl ">
 <div className="p-6 bg-surface">
 ...
 <div className="p-6 flex justify-end space-x-3 bg-surface">
 <button 
 onClick={() => setShowUpgradeDialog(false)} 
 className="px-6 py-3 bg-secondary/50 hover:bg-secondary text-foreground rounded-lg font-semibold transition-all"
 >
 Cancel
 </button>
 <button 
 onClick={handleUpgrade} 
 className="px-6 py-3 bg-primary hover:opacity-90 text-primary-foreground rounded-lg font-bold transition-all shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30"
 >
