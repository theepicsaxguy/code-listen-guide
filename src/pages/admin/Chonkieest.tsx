...
export default function chonkieTest() {
 ...
 className="w-full px-4 py-2 bg-card rounded-lg text-text placeholder:text-muted-foreground focus:outline-none focus:border-blue-500"
 />
 </div>
 ...
 min="1"
 max="5000"
 className="w-full px-4 py-2 bg-card rounded-lg text-text focus:outline-none focus:border-blue-500"
 />
 </div>

 {/* chonkie Options */}
 <div className="pt-6">
 <h3 className="text-text font-medium mb-4">chonkie Features</h3>
 ...
 />
 <div>
 <div className="text-text">Code Enrichment</div>
 ...
 />
 <div>
 <div className="text-text">Formula Enrichment</div>
 <div className="text-sm text-muted-foreground">
 ...
 />
 <div>
 <div className="text-text">Table Extraction</div>
 <div className="text-sm text-muted-foreground">
