    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex gap-4">
        ...
        <Button 
          ...
          className="bg-gradient-primary hover:opacity-90 text-primary-foreground shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:-translate-y-0.5 px-8"
        >
      ...
      <div className="bg-gradient-card-primary border border-primary/20 rounded-xl shadow-lg overflow-hidden">
        <Table>
          <TableHeader>
            <TableRow className="bg-gradient-to-r from-primary/10 to-accent/5 border-b border-primary/20 hover:bg-gradient-to-r hover:from-primary/15 hover:to-accent/10">
          ...
          <TableBody>
            {isLoading ? (
              ...
              users.map((user, idx) => (
                <TableRow 
                  key={user.id}
                  className={`transition-colors border-b border-border/30 ${idx % 2 === 0 ? 'hover:bg-gradient-primary/5' : 'hover:bg-gradient-accent/5'}`}
                >
      ...
      <div className="flex justify-between items-center">
        <Button
          ...
          disabled={page === 1}
          className="border-primary/30 hover:bg-gradient-primary hover:text-primary-foreground hover:border-primary/50 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Previous
        </Button>
        <span className="text-sm font-semibold text-primary px-4 py-2 bg-gradient-primary/10 rounded-lg border border-primary/20">
          Page {page}
        </span>
        <Button
          variant="outline"
          ...
          className="border-accent/30 hover:bg-gradient-accent hover:text-accent-foreground hover:border-accent/50"
        >
          Next
        </Button>
      </div>
